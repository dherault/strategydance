  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          'fixed z-50 flex flex-col gap-4 bg-popover bg-clip-padding font-sans text-sm text-popover-foreground shadow-lg transition duration-200 ease-in-out',
...
function SheetTitle({ className, ...props }: ComponentProps<typeof SheetPrimitive.Title>) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn('font-heading text-lg font-normal text-secondary', className)}
      {...props}
    />
  )
}
